#!/usr/bin/env python3
"""
scan-project.py — Deterministic project scanner for gd-shared-update-docs-project-standard skill.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Scan project documentation status for gd-shared-update-docs-project-standard skill."
    )
    parser.add_argument(
        "--root", default=".",
